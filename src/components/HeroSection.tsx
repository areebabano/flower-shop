  ...
  return (
    <section className="flex items-center justify-between p-10 bg-white">
      ...
      <div className="ml-14 flex-1">
        ...
        <p className="text-lg mb-6 text-gray-400">At 𝕱𝖑𝖔𝖗𝖆𝖑 𝕰𝖑𝖊𝖌𝖆𝖓𝖈𝖊&apos; we take pride in offering the finest selection of handpicked flowers, expertly arranged to suit every special moment. Whether you’re celebrating a wedding, birthday, anniversary, or just want to brighten someone's day, our flowers are carefully sourced and delivered fresh to your doorstep. Trust us to bring nature&apos;s beauty to your life with elegance and sophistication.</p>
